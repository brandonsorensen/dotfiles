...
" Last Updated: Fri 18 Sep 23:24:23 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi MatchWord guifg=#e7e8eb guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  ...
  hi PmenuSel guifg=#e7e8eb guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#d28e5d guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi CursorLine guifg=NONE guibg=#292c35 guisp=NONE gui=NONE cterm=NONE ctermbg=NONE
  hi QuickFixLine guifg=#e7e8eb guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  ...
  hi WildMenu guifg=#e7e8eb guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  ...
  if g:xcodewwdc_emph_types
    hi Typedef guifg=#b9b5f6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#c7faa4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#64dcd4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:xcodewwdc_emph_funcs
    hi FunctionDef guifg=#b9b5f6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#c7faa4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#64dcd4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:xcodewwdc_emph_idents
    hi IdentifierDef guifg=#b9b5f6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#c7faa4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#64dcd4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:xcodewwdc_match_paren_style
    ...
    hi MatchParen guifg=#e7e8eb guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodewwdc_dim_punctuation
    ...
    hi Delimiter guifg=#e7e8eb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#e7e8eb guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
